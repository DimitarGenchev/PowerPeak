    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=13, validators=[django.core.validators.RegexValidator(message='Телефонният номер трябва да започва с +359 или 0, последвано от 9 цифри.', regex='^(?:\\+359|0)\\d{9}$')])),
                ('date_of_birth', models.DateField(validators=[GymMembershipsApp.users.validators.validate_age_12_and_above])),
